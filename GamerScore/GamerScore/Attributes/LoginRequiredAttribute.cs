...
namespace GamerScore.Attributes
{
    public class LoginRequiredAttribute : ActionFilterAttribute
    {
        ...
        {
            ITokenService tokenService = context.HttpContext.RequestServices.GetService<ITokenService>() ?? throw new InvalidOperationException("ITokenService not found in LoginRequiredAttribute");
